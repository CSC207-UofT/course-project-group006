...
- [The Use of Github Features](#the-use-of-github-features)
...
We used all of the features recommended in the project several times. Every time we edit a new version, we will commit and push it to our repo and create a pull request, waiting for teammates to compare and merge if necessary. Also, we used the issue to post questions during coding. 
